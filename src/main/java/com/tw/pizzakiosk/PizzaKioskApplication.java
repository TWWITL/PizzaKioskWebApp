...
import com.tw.pizzakiosk.models.PizzaOrder;
...
public class PizzaKioskApplication {
    ...
    public String orderPizza(@ModelAttribute(value = "pizzaOrder") PizzaOrder pizzaOrder, Model model) throws Exception {
        ...
        try {
            ...
            double price = kiosk.makePizzaWith(crustsList.get(0), pizzaOrder.getSize(), pizzaOrder.getToppings());
